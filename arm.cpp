...
{
    setJointrRad(_c1*pi/180,_c2*pi/180,_c3*pi/180);
}
...
void Arm::setPos(float _x,float _y,float _z)
{
    if(ik_3(_x,_y,_z))
    {
        x=_x;y=_y;z=_z;
...
ArmAng  Arm::getAng()
{
    arm_ang.c1 = c1*180/pi;
    arm_ang.c2 = c2*180/pi;
    arm_ang.c3 = c3*180/pi;
    return  arm_ang;
}
